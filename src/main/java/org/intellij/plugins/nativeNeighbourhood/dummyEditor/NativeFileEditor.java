...
public class NativeFileEditor implements FileEditor {
    ...
    public void selectNotify() {
        // Problem: Can't return null from NativeFileEditorProvider#createEditor
        // Workaround: close dummy editor immediately after opening
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                // Problem: IDEA does not always reactivate the prior tab when closing the dummy editor
                // Workaround: remember last active file and reactivate its editor tab "manually"
